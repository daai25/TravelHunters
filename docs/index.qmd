...
- **[Project Charter](project_charter.qmd)**: Project definition, goals and planning
- **[Data Collection](data_collection.qmd)**: Details on spiders & process of the collection of data
- **[Data Report](data_report.qmd)**: Detailed description of all used datasets
- **[Modeling Report](modelling_report.qmd)**: Development and evaluation of recommendation models  
...
filtered_values = [
    60,   # Top-3 Accuracy %
    26,   # CNN Accuracy %
    70,   # Overall Accuracy Total %
    95,   # Data Pipeline %
    90    # User Satisfaction converted to % (4.5/5 * 100)
]
...
bars = plt.barh(filtered_df["KPI"], filtered_df["Value (%)"], color="mediumseagreen")
plt.xlabel("Value (%)")
plt.title("Selected Key Performance Indicators")
...
- **Web Scraping**: Scrapy Framework, Selenium, DDG_search, Google API
- **Data Processing**: Python, Pandas, SQLite
- **Machine Learning**: Scikit-learn, Surprise, Resnet
