...
# === KONFIGURATION ===
IMAGES_DIR = r"C:\Users\jabar\Downloads\geo_cities\geo_cities" # Replace with your actual image folder path
...
# Tabelle geo_city_images erstellen, falls sie nicht existiert
img_cursor.execute("""
    CREATE TABLE IF NOT EXISTS geo_city_images (
